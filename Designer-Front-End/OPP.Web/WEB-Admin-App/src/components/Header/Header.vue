        ...
        <b-nav class="ml-auto">
            <b-nav-item-dropdown class="notificationsMenu d-sm-down-none mr-2"
                ...
                <template slot="button-content">
                    <span class="avatar rounded-circle thumb-sm float-left mr-2 glyphicon glyphicon-user">
                    </span>
                    <span class="px-2">{{getNameUser()}}</span>
            ...
            <b-nav-item-dropdown id="v-step-2" class="settingsDropdown d-sm-down-none" no-caret right>
                ...
                <b-dropdown-item @click="myAccount"><i class='fi flaticon-person px-3 mr-3' /> My Account</b-dropdown-item>
                <!--<b-dropdown-item><i class='fi flaticon-calendar-9 px-3 mr-3' />Calendar</b-dropdown-item>-->
                <!--<b-dropdown-item>
                    <i class='fi flaticon-email px-3 mr-3' />
    ...
    export default {
        ...
        methods: {
            ...
            logout() {
                ...
                localStorage.removeItem('auth_trasactionDate');
